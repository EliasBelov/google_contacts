"""
    GOOGLE-LIB INJECTION FUNCTION UPD-TOKEN 

    модифицирование _client.py
    C:\py\synс_cont\venv\Lib\site-packages\google\oauth2\_client.py

    # Удаление токена. Провоцирование запуска модуля с генерированием ссылки.
    os.remove("C:/py/synс_cont/lib/API_Contacts/token.pickle")
    ...
    На случай обновления C:\py\sync_cont\venv\Lib\site-packages\google_authlib\flow.py:
    
            Вставить модуль извлечения и сохранения линка и добавить модуль запуска обработчика ZP:
